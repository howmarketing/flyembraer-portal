...
const UserManagement: NextPageWithLayout = () => {
	return (
		<>
			<Head>
				<title>Fly Embraer - Guides {">"} User Management</title>
				...
				<StyledWrapper>
					<StyledStep>
						...
						<Image
							...
							src="/img/Guides/user-management/user-management-1.jpg"
							alt="guide image"
						/>
					</StyledStep>
					...
					<StyledStep>
						...
						<Image
							className={StyledImage()}
							src="/img/Guides/user-management/user-management-2.jpg"
							alt="guide image"
						/>
					</StyledStep>
					...
					<StyledStep>
						<StyledStepTitle>
							...
							<span>Update information as desired.</span>
						</StyledStepTitle>

						<Image
							className={StyledImage()}
							src="/img/Guides/user-management/user-management-3.jpg"
							alt="guide image"
						/>
					</StyledStep>
					...
					<StyledStep>
						...
						<Image
							className={StyledImage()}
							src="/img/Guides/user-management/user-management-4.jpg"
							alt="guide image"
						/>
					</StyledStep>
				</StyledWrapper>
