...
const ReproveUsers: NextPageWithLayout = () => {
	const serviceList = [
		{
			id: 1,
	...
	return (
		<Flex css={{ flexDirection: "column" }}>
			<Text color="brand-primary" size="sm" weight="bold">
				{"USER MANAGEMENT > MULTI-EDIT > RE-APPROVE USER"}
			</Text>
...
export default ReproveUsers

ReproveUsers.getLayout = function getLayout(page: ReactElement) {
