...
const CompanyManagement: NextPageWithLayout = () => {
	return (
		<>
			<Head>
				<title>Fly Embraer - Guides {">"} Company Management</title>
				...
				<StyledWrapper>
					<StyledStep>
						<StyledStepTitle>
							...
							<span>First, you must select administration and then company management.</span>
						</StyledStepTitle>

						<Image
							className={StyledImage()}
							src="/img/Guides/company-management/company-management-1.jpg"
							alt="guide image"
						/>
					</StyledStep>
					...
					<StyledStep>
						<StyledStepTitle>
							...
							<span>The second step is to click on edit on the chosen company.</span>
						</StyledStepTitle>

						<Image
							className={StyledImage()}
							src="/img/Guides/company-management/company-management-2.jpg"
							alt="guide image"
						/>
					</StyledStep>
					...
					<StyledStep>
						<StyledStepTitle>
							...
							<span>Edit the details on the desired tab.</span>
						</StyledStepTitle>

						<Image
							className={StyledImage()}
							src="/img/Guides/company-management/company-management-3.jpg"
							alt="guide image"
						/>
					</StyledStep>
					...
					<StyledStep>
						...
						<Image
							className={StyledImage()}
							src="/img/Guides/company-management/company-management-4.jpg"
							alt="guide image"
						/>
					</StyledStep>
				</StyledWrapper>
