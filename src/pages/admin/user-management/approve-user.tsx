...
import { ProfileSelect as SelectProfile } from "components/SelectProfile/SelectProfile"
import Text from "components/Text"
import TextField from "components/TextField"
import { styled } from "@stitches/react"
import { useRouter } from "next/router"

const ApproveUser: NextPageWithLayout = () => {
	const serviceList = [
		{
			id: 1,
						...
						<EvenRow key={index}>
							...
							<Td>
								<SelectProfile
									id="profile"
									label=""
									css={{ width: "50%", marginBottom: "-50px", marginRight: "10px" }}
								/>
							</Td>
						</EvenRow>
					))}
	...
	return (
		<Flex css={{ flexDirection: "column" }}>
			<Text color="brand-primary" size="sm" weight="bold">
				{" "}
				{"USER MANAGEMENT > MULTI-EDIT > APPROVE USER"}
			</Text>
...
ApproveUser.getLayout = function getLayout(page: ReactElement) {
