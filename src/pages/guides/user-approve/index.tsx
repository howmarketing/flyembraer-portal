...
const UserApprove: NextPageWithLayout = () => {
	return (
		<>
			<Head>
				<title>Fly Embraer - Guides {">"} User Approve and Reject</title>
				...
				<StyledWrapper>
					<StyledStep>
						...
						<Image
							...
							src="/img/Guides/user-approve/user-approve-1.jpg"
							alt="guide image"
						/>
					</StyledStep>
					...
					<StyledStep>
						...
						<Image
							className={StyledImage()}
							src="/img/Guides/user-approve/user-approve-2.jpg"
							alt="guide image"
						/>
					</StyledStep>
					...
					<StyledStep>
						<StyledStepTitle>
							...
							<span>
								Change the “Status” from pending to reproved if you want to reprove, or approved if you
								want to approve.
							</span>
						</StyledStepTitle>
						...
						<Image
							className={StyledImage()}
							src="/img/Guides/user-approve/user-approve-3.jpg"
							alt="guide image"
						/>
					</StyledStep>
					...
					<StyledStep>
						...
						<Image
							className={StyledImage()}
							src="/img/Guides/user-approve/user-approve-4.jpg"
							alt="guide image"
						/>
					</StyledStep>
				</StyledWrapper>
...
UserApprove.getLayout = function getLayout(page: ReactElement) {
