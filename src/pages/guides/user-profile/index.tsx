...
const UserProfile: NextPageWithLayout = () => {
	return (
		<>
			<Head>
				<title>Fly Embraer - Guides {">"} User Profile</title>
				...
				<StyledWrapper>
					<StyledStep>
						...
						<Image
							...
							src="/img/Guides/user-profile/user-profile-1.jpg"
							alt="guide image"
						/>
					</StyledStep>
					...
					<StyledStep>
						...
						<Image
							className={StyledImage()}
							src="/img/Guides/user-profile/user-profile-2.jpg"
							alt="guide image"
						/>
					</StyledStep>
					...
					<StyledStep>
						<StyledStepTitle>
							...
							<span>Update the “Profile” field.</span>
						</StyledStepTitle>

						<Image
							className={StyledImage()}
							src="/img/Guides/user-profile/user-profile-3.jpg"
							alt="guide image"
						/>
					</StyledStep>
					...
					<StyledStep>
						...
						<Image
							className={StyledImage()}
							src="/img/Guides/user-profile/user-profile-4.jpg"
							alt="guide image"
						/>
					</StyledStep>
				</StyledWrapper>
